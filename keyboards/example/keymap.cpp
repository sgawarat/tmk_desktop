...
action_t action_for_key(uint8_t layer, keypos_t pos) {
  ...
  static constexpr std::array SHIFTED_COLEMAK_P_ACTIONMAP{
    ...
    AC_SHIFT_Z, AC_SHIFT_X, AC_SHIFT_C, AC_SHIFT_V, AC_SHIFT_B, AC_SHIFT_K, AC_SHIFT_M, AC_LT, AC_GT, AC_QUESTION, AC_UNDERSCORE,
  ...
  static constexpr std::array THUMB_ACTIONMAP{  // WIP
    AC_HANKAKU_ZENKAKU, AC_NO, AC_NO, AC_NO, AC_NO, AC_NO, AC_NO, AC_NO, AC_NO, AC_NO, AC_NO, AC_NO, AC_NO, AC_NO,
    AC_NO, AC_LBRACKET, AC_EXCLAIM, AC_NO, AC_NO, AC_NO, AC_NO, AC_PIPE, AC_RBRACKET, AC_NO, AC_NO, AC_NO,
    AC_DQUOTE, AC_ASTERISK, AC_LBRACE, AC_LPAREN, AC_HASH, AC_DOLLAR, AC_RPAREN, AC_RBRACE, AC_AMPERSAND, AC_QUOTE, AC_TILDE, AC_NO,
    AC_NO, AC_GRAVE, AC_PERCENT, AC_BSLASH, AC_NO, AC_NO, AC_AT, AC_CIRCUMFLEX, AC_RIGHT_ARROW, AC_BLOCK_COMMENT_BEGIN, AC_NO,
    AC_LTHUMB_MUHENKAN, AC_RTHUMB_HENKAN,
  ...
  static constexpr std::array OTHERS_ACTIONMAP{
    ...
    AC_BSPACE, AC_TAB, AC_CAPSLOCK, AC_ENTER, AC_SPACE, AC_KATAKANA_HIRAGANA, AC_APPLICATION,
